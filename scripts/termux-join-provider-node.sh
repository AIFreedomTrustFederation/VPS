...
say "Preparing Termux provider node: $NODE_NAME"
...
if [ ! -d "$WORK_DIR/.git" ]; then
  say "Cloning repo to $WORK_DIR"
  git clone "$REPO_URL" "$WORK_DIR"
else
  say "Updating repo at $WORK_DIR"
  cd "$WORK_DIR"
...
AIFT_NODE_KIND=termux-provider-node
...
============================================================
AIFT MULTI-DEVICE NODE LIVE REPORT
============================================================
